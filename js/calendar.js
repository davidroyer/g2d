$(function(){
    ...
    $('#public-calendar').fullCalendar({
        ...
        eventMouseover: function(calEvent, jsEvent, view){
            var tooltip = '<div class="event-tooltip">' + calEvent.title + '<br><br>' + calEvent.description + '</div>';
            $("body").append(tooltip);
...
$(function(){
    ...
    function modal(data) {
        ...
        if( ! data.event) {
            ...
            var momentTime = momentObj.format("h:mm A");
        } else {
    ...
    function getTime() {
        ...
        var momentTime = momentObj.format("HH:mm");
        return (momentTime.indexOf(':') == 1 ? '0' + momentTime : momentTime) + ':00';
